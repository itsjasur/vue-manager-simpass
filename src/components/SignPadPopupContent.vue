<template>
  <div class="signpad_main">
    <div ref="fullscreenElement" class="signpad_main_content">
      <div class="buttons">
...
watch(signPenSickness, (n) => {
  if (padData) {
    padData.off() // Detach event handlers
    padData = null
  }
...
const length = props.overlayText.length
